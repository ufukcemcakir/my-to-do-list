...
function addTaskToList(taskList, taskData, projectName) {
  ...
  taskDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(taskData.dueDate), 'MMM d, yyyy');
...
function updateTaskDisplay(taskItem, taskData) {
  ...
  taskItem.querySelector('.task-date').textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(taskData.dueDate), 'MMM d, yyyy');
  ...
  projects.forEach(projectName => {
    ...
    projectButton.addEventListener("click", () => {
      if (!projectButton.classList.contains("active")) {
        ...
        (0,_project_generator__WEBPACK_IMPORTED_MODULE_0__["default"])(projectName);
      }
    });
...
function createWebsite() {
  ...
  if (lastActiveProject) {
    (0,_project_generator__WEBPACK_IMPORTED_MODULE_0__["default"])(lastActiveProject);
